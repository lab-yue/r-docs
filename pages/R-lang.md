...
Previous: [Group methods](#Group-methods), Up: [Object-oriented
programming](#Object_002doriented-programming)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
interfaces](#System-and-foreign-language-interfaces), Previous:
[Object-oriented programming](#Object_002doriented-programming), Up:
[Top](#Top)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Substitutions](#Substitutions), Previous: [Computing on the
language](#Computing-on-the-language), Up: [Computing on the
language](#Computing-on-the-language)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [More on evaluation](#More-on-evaluation), Previous: [Direct
manipulation of language
objects](#Direct-manipulation-of-language-objects), Up: [Computing on
the language](#Computing-on-the-language)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
would be meaningless to evaluate, like '`'.
...
is inserted, *except* if matching against the global environment. If it
...
*after* `y` has been modified. The solution is to force `ylab` to be
evaluated first, i.e.,
...
objects](#Evaluation-of-expression-objects), Previous:
[Substitutions](#Substitutions), Up: [Computing on the
language](#Computing-on-the-language)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Manipulation of function calls](#Manipulation-of-function-calls),
Previous: [More on evaluation](#More-on-evaluation), Up: [Computing on
the language](#Computing-on-the-language)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]

### 6.4 Evaluation of expression objects 

Objects of mode `"expression"` are defined in [Expression
objects](#Expression-objects). They are very similar to lists of call
objects.
...
`quote()`. However, there is a subtle difference: Call
...
Next: [Manipulation of functions](#Manipulation-of-functions), Previous:
[Evaluation of expression objects](#Evaluation-of-expression-objects),
Up: [Computing on the language](#Computing-on-the-language)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Previous: [Manipulation of function
calls](#Manipulation-of-function-calls), Up: [Computing on the
language](#Computing-on-the-language)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Exception handling](#Exception-handling), Previous: [Computing on
the language](#Computing-on-the-language), Up: [Top](#Top)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Foreign language interfaces](#Foreign-language-interfaces),
...
Next: [.Internal and .Primitive](#g_t_002eInternal-and-_002ePrimitive),
...
See [System and foreign language
interfaces](./R-exts.html#System-and-foreign-language-interfaces) in
...
Previous: [Foreign language interfaces](#Foreign-language-interfaces),
Up: [System and foreign language
interfaces](#System-and-foreign-language-interfaces)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Debugging](#Debugging), Previous: [System and foreign language
...
Next: [warning](#warning), Previous: [Exception
handling](#Exception-handling), Up: [Exception
handling](#Exception-handling)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [on.exit](#on_002eexit), Previous: [stop](#stop), Up: [Exception
handling](#Exception-handling)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Error options](#Error-options), Previous: [warning](#warning),
Up: [Exception handling](#Exception-handling)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Previous: [on.exit](#on_002eexit), Up: [Exception
handling](#Exception-handling)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Parser](#Parser), Previous: [Exception
handling](#Exception-handling), Up: [Top](#Top)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [debug/undebug](#debug_002fundebug), Previous:
...
Next: [trace/untrace](#trace_002funtrace), Previous:
[browser](#browser), Up: [Debugging](#Debugging)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [traceback](#traceback), Previous:
[debug/undebug](#debug_002fundebug), Up: [Debugging](#Debugging)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Previous: [trace/untrace](#trace_002funtrace), Up:
[Debugging](#Debugging)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Previous: [Debugging](#Debugging), Up: [Top](#Top)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Comments](#Comments), Previous: [Parser](#Parser), Up:
[Parser](#Parser)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Internal representation](#Internal-representation), Previous:
[The parsing process](#The-parsing-process), Up: [The parsing
process](#The-parsing-process)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Deparsing](#Deparsing), Previous: [Modes of
parsing](#Modes-of-parsing), Up: [The parsing
process](#The-parsing-process)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
A fuller description of such objects can be found in [Language
objects](#Language-objects) and [Expression
objects](#Expression-objects). Briefly, every elementary R expression is
...
actual arguments. Note that *all* R syntax elements are treated in this
way, e.g. the assignment `x <- 1` is encoded as `"<-"(x, 1)`.

------------------------------------------------------------------------

 
Previous: [Internal representation](#Internal-representation), Up: [The
parsing process](#The-parsing-process)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Tokens](#Tokens), Previous: [The parsing
process](#The-parsing-process), Up: [Parser](#Parser)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Expressions](#Expressions), Previous: [Comments](#Comments), Up:
[Parser](#Parser)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
They are recognised during *lexical analysis* which (conceptually, at
...
Next: [Identifiers](#Identifiers), Previous: [Tokens](#Tokens), Up:
[Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Reserved words](#Reserved-words), Previous: [Literal
constants](#Literal-constants), Up: [Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
operators or replacement functions. The following pairs are *not*
equivalent  
...
Next: [Special operators](#Special-operators), Previous:
[Identifiers](#Identifiers), Up: [Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Separators](#Separators), Previous: [Reserved
words](#Reserved-words), Up: [Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Operator tokens](#Operator-tokens), Previous: [Special
operators](#Special-operators), Up: [Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Grouping](#Grouping), Previous: [Separators](#Separators), Up:
[Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Indexing tokens](#Indexing-tokens), Previous: [Operator
tokens](#Operator-tokens), Up: [Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Previous: [Grouping](#Grouping), Up: [Tokens](#Tokens)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Directives](#Directives), Previous: [Tokens](#Tokens), Up:
[Parser](#Parser)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Infix and prefix operators](#Infix-and-prefix-operators),
Previous: [Expressions](#Expressions), Up: [Expressions](#Expressions)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Index constructions](#Index-constructions), Previous: [Function
calls (expressions)](#Function-calls-_0028expressions_0029), Up:
[Expressions](#Expressions)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
arbitrary right hand sides and is discussed under [Index
constructions](#Index-constructions). It has higher precedence than any
...
Next: [Compound expressions](#Compound-expressions), Previous: [Infix
and prefix operators](#Infix-and-prefix-operators), Up:
[Expressions](#Expressions)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Flow control elements](#Flow-control-elements), Previous: [Index
constructions](#Index-constructions), Up: [Expressions](#Expressions)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Next: [Function definitions](#Function-definitions), Previous: [Compound
expressions](#Compound-expressions), Up: [Expressions](#Expressions)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Previous: [Flow control elements](#Flow-control-elements), Up:
[Expressions](#Expressions)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
Previous: [Expressions](#Expressions), Up: [Parser](#Parser)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
previous directive.) This is not typically used by users, but may be
used by preprocessors so that diagnostic messages refer to the original
file.

------------------------------------------------------------------------

 
Next: [Concept Index](#Concept-Index), Previous: [Parser](#Parser), Up:
[Top](#Top)  
\[[Contents](#SEC_Contents "Table of contents")\]\[[Index](#Function-and-Variable-Index "Index")\]
...
[Direct manipulation of language
objects](#Direct-manipulation-of-language-objects)
